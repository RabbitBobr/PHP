...
// Обновление капчи
    ...
    $('#button-remind').click(function(){
        ...
        {
            $("#remind-email").css("borderColor","#EC102E");
    ...
    $('.count-minus').click(function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // РїРµСЂРµРјРµРЅРЅР°СЏ СЃ С†РµРЅРЅРѕР№ РїСЂРѕРґСѓРєС‚Р°
                var priceproduct = $("#tovar"+iid+" > p").attr("price");
                // Р¦РµРЅСѓ СѓРјРЅРѕР¶Р°РµРј РЅР° РєРѕР»Р»РёС‡РµСЃС‚РІРѕ
